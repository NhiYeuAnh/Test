...
Teleport = Window:AddTab({ Title = "Teleports Island", Icon = "" }),
...
local listfastattack = {'Normal','Slow','Super','Low','speed','Extra'}
	...
	if _G.FastAttack_Mode == "Slow" then
		_G.Fast_Delay = 0.10
	elseif _G.FastAttack_Mode == "Normal" then
		_G.Fast_Delay = 0.07
	elseif _G.FastAttack_Mode == "Mediaum" then
		_G.Fast_Delay = 0.01
	elseif _G.FastAttack_Mode == "Low" then
		_G.Fast_Delay = 0.018	
	elseif _G.FastAttack_Mode == "Fast Speed" then
		_G.Fast_Delay = 0.009	
	elseif _G.FastAttack_Mode == "Extra" then
		_G.Fast_Delay = 0.001
   elseif _G.FastAttack_Mode == "Super"
        _G.Fast_Delay = 0
	end
end)

    local DropdownSelectWeapon = Tabs.Main:AddDropdown("DropdownSelectWeapon", {
        Title = "Select Famer Weapon",
        Description = "",
