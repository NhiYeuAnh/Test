...
local YMIENotify = function(Text_i,Duration_i)
    game.StarterGui:SetCore("SendNotification", {
        Title = "YMIE HUB",
        Text = Text_i,
        Duration = Duration_i,
        Icon = "rbxassetid://17663245942"
    })
end
--Key
wait(0.1)
YMIENotify("Thank You So Much To use Script Me",5)
wait(0.1)
YMIENotify("Devloper Nhisad",5)
wait(0.5)
local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Cyan>YMIE Hub V2Script<Color=/>"):Display()
wait(0.5)
...
local Farm = a:Tab("Other Farmer", "rbxassetid://15712717270")
...
HomePage:Seperator("YMIE HUB")

HomePage:Label("Blox Fruits | Free Version")

HomePage:Seperator("Status")
local YMIEStatuOn_Time = HomePage:Label("")
local YMIEStatuOn_Player = HomePage:Label("Name : "..game.Players.LocalPlayer.Name)
local YMIEStatuOn_FPS = HomePage:Label("")
local YMIEStatuOn_Ping = HomePage:Label("")
function AUpdateInfo()
    ...
    YMIEStatuOn_Time:Set("Time : ".. hour .. " : " .. minute .. " : " .. second)
    YMIEStatuOn_FPS:Set("FPS : "..fps)
    YMIEStatuOn_Ping:Set("Ping : "..Ping)
end
task.spawn(function()
    while task.wait() do
        AUpdateInfo()
...
HomePage:Button("Copy Discord Link", function()
    YMIENotify("Copy Discord Link!",5)
